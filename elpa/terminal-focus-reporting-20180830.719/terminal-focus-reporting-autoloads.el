;;; terminal-focus-reporting-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
If called interactively, enable Terminal-Focus-Reporting mode if
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "terminal-focus-reporting" '("terminal-focus-reporting-")))
