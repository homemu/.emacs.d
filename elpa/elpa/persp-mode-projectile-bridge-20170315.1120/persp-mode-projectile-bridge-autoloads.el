;;; persp-mode-projectile-bridge-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "persp-mode-projectile-bridge" '("persp-mode-projectile-bridge-")))
